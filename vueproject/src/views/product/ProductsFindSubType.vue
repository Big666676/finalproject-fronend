    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-main>
          ...
          <el-row class="product-row animate__animated animate__fadeInRight"
            style="margin: auto; display: flex; justify-content: center;flex-wrap: wrap;">
...
const loading = async () => {
  ...
  const VITE_API_GAMESHOP_INITPRODUCTTYPE = `${import.meta.env.VITE_JAVA_URL
    }/gameshop/product/find/subtype/`;
  const response = await axios.post(
    VITE_API_GAMESHOP_INITPRODUCTTYPE + subtype
  );
